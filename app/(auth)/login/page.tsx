        ...
        >
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              ...
              <Link href="#" className="text-xs text-amber-600 hover:underline text-right">Forgot password?</Link>
            </div>
          ...
          <Button 
            type="submit" 
            disabled={loading}
            className="w-full h-12 bg-amber-600 text-white hover:bg-amber-700 rounded-xl font-bold"
          >
          ...
          <div className="relative py-2">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-card px-2 text-slate-400 font-medium">Or continue with</span>
            </div>
          </div>
          ...
          <Button
            ...
            disabled={loading}
            className="w-full h-12 border-slate-200 bg-white hover:bg-slate-50 rounded-xl font-semibold flex items-center justify-center gap-3 transition-smooth shadow-sm"
          >
